...
import { classifyWeather, getMenuById, recommendMenu } from './utils/recommend'
...
function App() {
  ...
  function handleRecommend() {
    ...
    const menu = recommendMenu(condition, recentIds)
    setCurrentMenu(menu)
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-slate-100 px-4 py-10 dark:from-slate-900 dark:to-slate-950">
      <div className="mx-auto flex max-w-md flex-col gap-6">
        <header className="text-center">
          <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100">오늘 점심 뭐 먹지?</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">날씨에 딱 맞는 점심 메뉴를 추천해드려요</p>
        </header>
